...
#AUTHOR : CHIGOZIEWORLDWIDE (RED)
#OPEN SOURCE :)
#DON'T FORGET TO GIVE CREDIT TO RED
...
header = {"user-agent": '[Mozilla/5.0 (Windows; U; Windows NT 5.2; en-US) AppleWebKit/533.17.8 (KHTML, like Gecko) Version/5.0.1 Safari/533.17.8;]',
